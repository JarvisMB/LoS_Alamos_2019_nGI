...
def normalization(stack_im,stack_ob,xROI=xROI,yROI=yROI,widthROI=widthROI,heightROI=heightROI,show=False):
    """
...
def saveIm(ti,dpci,dfi,vis_map,name='name',folder='folder',overWrite=False):
    ...
    fits.writeto(folder+'/ti/ti_'+str(name)+'.fits',ti,overwrite=overWrite)
    fits.writeto(folder+'/dpci/dpci_'+str(name)+'.fits',dpci,overwrite=overWrite)
    fits.writeto(folder+'/dfi/dfi_'+str(name)+'.fits',dfi,overwrite=overWrite)
    fits.writeto(folder+'/visi/visi_'+str(name)+'.fits',vis_map,overwrite=overWrite)
